...
type NewQueryFunc func(query *kolide.Query) (*kolide.Query, error)
...
type QueryByNameFunc func(name string) (*kolide.Query, bool, error)
...
func (s *QueryStore) NewQuery(query *kolide.Query) (*kolide.Query, error) {
	s.NewQueryFuncInvoked = true
	return s.NewQueryFunc(query)
}
...
func (s *QueryStore) QueryByName(name string) (*kolide.Query, bool, error) {
	s.QueryByNameFuncInvoked = true
	return s.QueryByNameFunc(name)
}
