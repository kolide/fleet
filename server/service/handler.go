...
func MakeKolideServerEndpoints(svc kolide.Service, jwtKey string) KolideEndpoints {
	return KolideEndpoints{
		...
		DeleteInvite:                   authenticatedUser(jwtKey, svc, mustBeAdmin(makeDeleteEntityEndpoint(svc))),
		...
		DeleteQuery:                    authenticatedUser(jwtKey, svc, makeDeleteEntityEndpoint(svc)),
		...
		DeletePack:                authenticatedUser(jwtKey, svc, makeDeleteEntityEndpoint(svc)),
		...
		DeleteScheduledQuery:      authenticatedUser(jwtKey, svc, makeDeleteEntityEndpoint(svc)),
		...
		DeleteHost:                authenticatedUser(jwtKey, svc, makeDeleteEntityEndpoint(svc)),
		...
		DeleteLabel:               authenticatedUser(jwtKey, svc, makeDeleteEntityEndpoint(svc)),
...
func makeKolideKitHandlers(ctx context.Context, e KolideEndpoints, opts []kithttp.ServerOption) *kolideHandlers {
	...
	return &kolideHandlers{
		...
		DeleteInvite:                   newServer(e.DeleteInvite, decodeDeleteEntityRequest(&kolide.Invite{})),
		...
		DeleteQuery:                    newServer(e.DeleteQuery, decodeDeleteEntityRequest(&kolide.Query{})),
		...
		DeletePack:                    newServer(e.DeletePack, decodeDeleteEntityRequest(&kolide.Pack{})),
		...
		DeleteScheduledQuery:          newServer(e.DeleteScheduledQuery, decodeDeleteEntityRequest(&kolide.ScheduledQuery{})),
		...
		DeleteLabel:                   newServer(e.DeleteLabel, decodeDeleteEntityRequest(&kolide.Label{})),
		...
		DeleteHost:                    newServer(e.DeleteHost, decodeDeleteEntityRequest(&kolide.Host{})),
