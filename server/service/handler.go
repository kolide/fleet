...
func makeKolideKitHandlers(ctx context.Context, e KolideEndpoints, opts []kithttp.ServerOption) *kolideHandlers {
	...
	return &kolideHandlers{
		...
		DeleteInvite:                   newServer(e.DeleteInvite, decodeDeleteEntityRequest("invites")),
		...
		DeletePack:                    newServer(e.DeletePack, decodeDeleteEntityRequest("packs")),
		...
		DeleteLabel:                   newServer(e.DeleteLabel, decodeDeleteEntityRequest("labels")),
		...
		DeleteHost:                    newServer(e.DeleteHost, decodeDeleteEntityRequest("hosts")),
