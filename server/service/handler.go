...
func attachKolideAPIRoutes(r *mux.Router, h *kolideHandlers) {
	...
	r.Handle("/api/v1/kolide/users/{id}/enable", h.EnableUser).Methods("PATCH").Name("enable_user")
	r.Handle("/api/v1/kolide/users/{id}/admin", h.AdminUser).Methods("PATCH").Name("admin_user")
