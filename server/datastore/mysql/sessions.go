...
func (d *Datastore) SessionByKey(key string) (*kolide.Session, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "error selecting sessions")
	}
...
func (d *Datastore) SessionByID(id uint) (*kolide.Session, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "error selecting session by id")
	}
...
func (d *Datastore) ListSessionsForUser(id uint) ([]*kolide.Session, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "error selecting sessions for user")
	}
...
func (d *Datastore) NewSession(session *kolide.Session) (*kolide.Session, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "error inserting session")
	}
...
func (d *Datastore) DestroyAllSessionsForUser(id uint) error {
	...
	if err != nil {
		return errors.Wrap(err, "error deleting sessions for user")
	}
...
func (d *Datastore) MarkSessionAccessed(session *kolide.Session) error {
	...
	if err != nil {
		return errors.Wrap(err, "error updating mark session as accessed")
	}
