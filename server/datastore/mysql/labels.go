...
func (d *Datastore) NewLabel(label *kolide.Label) (*kolide.Label, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "error inserting label")
	}
...
func (d *Datastore) Label(lid uint) (*kolide.Label, error) {
	...
	if err := d.db.Get(label, sql, lid); err != nil {
		return nil, errors.Wrap(err, "error selecting label")
	}
...
func (d *Datastore) ListLabels(opt kolide.ListOptions) ([]*kolide.Label, error) {
	...
	if err := d.db.Select(&labels, sql); err != nil {
		return nil, errors.Wrap(err, "error selecting labels")
	}
...
func (d *Datastore) LabelQueriesForHost(host *kolide.Host, cutoff time.Time) (map[string]string, error) {
	...
	if err != nil && err != sql.ErrNoRows {
		return nil, errors.Wrap(err, "error selecting label queries for host")
	}
	...
	for rows.Next() {
		...
		if err = rows.Scan(&id, &query); err != nil {
			return nil, errors.Wrap(err, "error scanning label queries for host")
		}
...
func (d *Datastore) RecordLabelQueryExecutions(host *kolide.Host, results map[string]bool, updated time.Time) error {
	...
	if err != nil {
		return errors.Wrap(err, "error inserting label query execution")
	}
...
func (d *Datastore) ListLabelsForHost(hid uint) ([]kolide.Label, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "error selecting host labels")
	}
	return labels, nil
...
func (d *Datastore) ListHostsInLabel(lid uint) ([]kolide.Host, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "error selecting label query executions")
	}
	return hosts, nil
}
...
func (d *Datastore) ListUniqueHostsInLabels(labels []uint) ([]kolide.Host, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "error building query listing unique hosts in labels")
	}
	...
	if err != nil {
		return nil, errors.Wrap(err, "error listing unique hosts in labels")
	}
...
func (d *Datastore) searchLabelsWithOmits(query string, omit ...uint) ([]kolide.Label, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "error building query for labels with omits")
	}
	...
	if err != nil {
		return nil, errors.Wrap(err, "error selecting labels with omits")
	}
...
func (d *Datastore) SearchLabels(query string, omit ...uint) ([]kolide.Label, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "error selecting labels for search")
	}
