...
func testLoadPacksForQueries(t *testing.T, ds kolide.Datastore) {
	...
	test.NewScheduledQuery(t, ds, p2.ID, q1.ID, 60, false, true, false)
	...
	test.NewScheduledQuery(t, ds, p3.ID, q2.ID, 60, false, true, false)
	...
	test.NewScheduledQuery(t, ds, p3.ID, q1.ID, 60, false, true, false)
