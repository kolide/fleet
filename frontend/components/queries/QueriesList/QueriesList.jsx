      ...
      <tr>
        <td colSpan={6}>
          <div className={`${baseClass}__first-query`}>
            ...
            <p><strong>platform:</strong> the operating system that matters</p>
            ...
            <ul>
              ...
              <li><strong><Icon name="bold-plus" /> differential (ignore removals):</strong> show something different</li>
