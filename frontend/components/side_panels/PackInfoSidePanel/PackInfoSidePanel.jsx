...
const PackInfoSidePanel = () => {
  return (
    <SecondarySidePanelContainer className={baseClass}>
      ...
      <p>The results of queries run via query packs are stored in log files for your connivence. We recommend forwarding this logs to a log aggregation tool or other actionable tool for further analysis. These logs can be found in the following locations:</p>
      <ul>
